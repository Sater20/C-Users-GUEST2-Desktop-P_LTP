...
<body>
    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-lg-6">
                <img class="img-fluid" src="<?= $item_producto->imagen?>" alt="<?= $item_producto->nombre_producto ?>" style="max-height: 400px; object-fit: contain; background-color: #f8f9fa; width: 100%;">
            </div>
            <div class="col-lg-6 mt-5">
                ...
                <div class="mt-4 mb-4">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <input type="number" id="cantidad" class="form-control" style="width: 100px;" value="1" min="1" max="<?= $item_producto->cantidad?>" onchange="validarcantidad()">
                    </div>
                    <small class="text-muted">Disponible: <?= $item_producto->cantidad?> unidades</small>
                </div>
                <div class="mt-4">
                    <form method="POST" action="controllers/carrito_controller.php" class="mb-3">
                        ...
                        <button type="submit" name="agregar_carrito" class="btn btn-warning btn-lg w-100 mb-3">
