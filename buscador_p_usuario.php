...
<head>
    ...
    <title>Resultados de Búsqueda - La Tienda Del Pintor</title>
</head>
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex mx-auto" method="GET" action="buscador_p_usuario.php">
                        <input class="form-control me-2 border-danger" type="text" name="resultado" placeholder="Buscar" aria-label="Buscar" value="<?= htmlspecialchars($resultado) ?>"/>
    ...
    <div class="container mt-4">
        ...
        <div class="mb-4">
            <h2 class="fw-bold text-dark mb-0"><?= htmlspecialchars($resultado) ?></h2>
            <hr class="border-3 border-warning mt-2 mb-0" style="opacity: 1; width: 300px;">
        </div>
        ...
        <div class="row g-4">
            <?php
            if(!empty($resultado)) {
                $sql = $conn->prepare("SELECT * FROM productos WHERE nombre_producto LIKE ? ORDER BY nombre_producto");
                $busqueda = "%$resultado%";
                ...
                <div class="col-12 text-center py-5">
                    <i class="bi bi-search display-1 text-muted"></i>
                    <h4 class="mt-3 text-muted">Ingresa un término de búsqueda</h4>
                    <p class="text-muted">Usa el buscador para encontrar productos</p>
                </div>
            <?php } ?>
        </div>
    </div>
