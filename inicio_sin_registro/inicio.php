...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-3">
                        <li class="nav-item">
                            <a class="nav-link" href="../sesion_registrar/iniciar_sesion.php">Iniciar Sesión</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container mb-5">
        <div class="row text-center">
            <div class="col-12">
                <h2 class="display-5 fw-bold text-primary mb-3">¡Bienvenido a La Tienda Del Pintor!</h2>
    ...
    <div class="container">
                    ...
                    <div class="card h-100 shadow-sm border-0 product-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <a href="../sesion_registrar/iniciar_sesion.php" class="btn btn-warning w-100 fw-bold mb-2">
                                    <i class="bi bi-cart-plus"></i> Agregar al Carrito
                                </a>
                                <a href="detalle_producto.php?id_produtos=<?= $item->id_productos?>" class="btn btn-outline-primary w-100">
        ...
        <div class="row mt-5">
            <div class="col-12 text-center">
                <a href="../sesion_registrar/iniciar_sesion.php" class="btn btn-primary btn-lg px-5">
                ...
                <div class="col-12">
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="../sesion_registrar/iniciar_sesion.php" class="btn btn-outline-primary">
